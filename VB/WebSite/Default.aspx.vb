...
Partial Public Class _Default
	...
	Private Sub CreateTask(ByVal employee As Employee, ByVal taskName As String, ByVal status As Integer, ByVal label As Integer)
		...
		task.Created = Date.Today + TimeSpan.FromHours(RandomInstance.Next(0, rangeInHours))
		task.Finish = task.Created.Add(TimeSpan.FromHours(RandomInstance.Next(0, rangeInHours \ 12)))
